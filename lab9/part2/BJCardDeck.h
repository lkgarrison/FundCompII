...
class BJCardDeck {
	...
	public:
		...
		void play();				// play blackjack using card deck

	private:
		NDVector<int> deck;			// NDVector to store deck of cards
		...
		int dealerWins;				// number of wins for dealer
		int playerWins;				// number of wins for player
};
